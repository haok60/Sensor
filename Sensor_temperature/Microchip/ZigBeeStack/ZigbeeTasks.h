...
typedef enum _ZIGBEE_PRIMITIVE
{
    ...
    APSME_ESTABLISH_KEY_request,        //0x5e
    APSME_ESTABLISH_KEY_confirm,        //0x5f
    APSME_ESTABLISH_KEY_indication,     //0x60
    APSME_ESTABLISH_KEY_response,       //0x61
    APSME_TRANSPORT_KEY_request,        //0x62
    APSME_TRANSPORT_KEY_indication,     //0x63
    APSME_UPDATE_DEVICE_request,        //0x64
    APSME_UPDATE_DEVICE_indication,     //moi hang tang len 1 gia tri
    APSME_REMOVE_DEVICE_request,
    APSME_REMOVE_DEVICE_indication,
    APSME_REQUEST_KEY_request,
    APSME_REQUEST_KEY_indication,
