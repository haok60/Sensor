...
typedef struct _ROUTING_ENTRY //thong tin tuyen truyen
{
    SHORT_ADDR      destAddress;    //dia chi dich cua tuyen
    ROUTE_STATUS    status;     // 3 bits valid // trang thai tuyen
    SHORT_ADDR      nextHop;	 //dia chi chang ke tiep
	#if defined(AODV_POWER_CONTROL)
